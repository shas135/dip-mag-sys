...
class Feature_extraction():
    columns = ["ts", "flow_duration","Header_Length","Protocol Type","Duration","Rate","Srate","Drate","fin_flag_number","syn_flag_number","rst_flag_number","psh_flag_number","ack_flag_number","ece_flag_number","cwr_flag_number",
               "ack_count", "syn_count", "fin_count","urg_count","rst_count", "HTTP", "HTTPS", "DNS", "Telnet","SMTP", "SSH", "IRC", "TCP", "UDP", "DHCP","ARP", "ICMP", 
                   #"IGMP", 
               "IPv", "LLC", "Tot sum", "Min", "Max", "AVG", "Std","Tot size", "IAT", "Number", "Magnitue","Radius","Covariance","Variance", "Weight"
               ]
    '''
    ...
    '''
                new_row = {
                          ...
                          "cwr_flag_number":flag_valus[7],      
                           ...
                           "IAT": IAT, 
                           "Number": len(ethsize),#1,                            #Number of packets
                           "Magnitue": magnite, 
                           "Radius":radius, 
        ...
        while last_row<len(processed_df):
            ...
            #!!!!sip, dip, sp, dp, proto
            sliced_df["SourceIP"] = src_ip
            sliced_df["DestIP"] = dst_ip
            sliced_df["SourcePort"] = src_port
            sliced_df["DestPort"] = dst_port
            #!!!!
